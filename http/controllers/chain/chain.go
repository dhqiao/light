...
func SetPost(c *gin.Context) {
	key := "name"
	value := "{\"houseList\":[{\"buildingArea\":\"string\",\"buildingYear\":\"string\",\"floor\":0,\"location\":\"string\",\"oldWarrantNo\":[\"string\"],\"structure\":\"string\",\"totalFloor\":0,\"unitNo\":[\"123\",\"455\"],\"using\":\"string\",\"warrantNo\":[\"string\"]}]}"
